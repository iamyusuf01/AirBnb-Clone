...
const Cards = () => {
    return (
        <div className="py-16 flex justify-evenly flex-wrap max-[740px]: sm:pt-[100px] sm:grid-cols-2  ">
            {
                CardList.map((card, j) => {
                    return (
                        <div className='max-[740px]:pb-3  '>
                            <div className=" max[740px]:w-[300px] flex p-2 pt-3 font-medium text-black leading-5 rounded-3xl h-[280px] w-[280px] relative hover:scale-95 transition-all">
